		...
		<div class="container">									
			...
			<div class="row">													
				<div class="col-lg-12 col-sm-12 col-xs-12 wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.1s" data-wow-offset="0">
					<div class="cat_list">
						<ul>
							<li><a href="#"> مصادر تلوّث الأوساط المائيّة و المحافظة على سلامة هذه الأوساط  <img src="assets/img/e2.png" alt="category-image" /> </a></li>
						...
						<table class="table table-hover text-center align-middle" id="table">
							...
							<tbody>
								@foreach($sources as $source)
									@if($source->lecon == 'source')
										<tr>
											<td>{{ $source->nom }}</td>
											<td>{!! nl2br(e($source->def)) !!}</td>
										</tr>
									@endif
								@endforeach
							</tbody>
